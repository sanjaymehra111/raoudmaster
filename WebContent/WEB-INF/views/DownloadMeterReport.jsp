        	...
        	$.ajax({
        		...
        		success:function(data){
        			...
        			for(var i=0; i<data.length; i++) {
						...
						html+='<td>'+data[i].shop.toUpperCase()+'</td>';
						html+='<td>'+data[i].meter+'</td>';
						html+='<td>'+data[i].charge+'</td>';
						if(data[i].status == "1")
							html+='<td style="text-align:center; color:#84e684; text-transform: uppercase; font-weight: bold;"> oepn </td>';
						else
							html+='<td style="text-align:center; color:#f35d5d; text-transform: uppercase; font-weight: bold;"> close </td>';

						html+='</tr>';
        			}
        			$(".usermeterlist").html(html);
	    ...
	    <table id="example" class="table-bordered table_padding" style="width: 100%; color: white;">
			<thead>
				<tr>
					...
					<td  style="text-align:center; padding:8px;  font-size:12px; font-weight:bold; text-transform: uppercase;">Meter Charge</td>
					<td  style="text-align:center; padding:8px;  font-size:12px; font-weight:bold; text-transform: uppercase;">Status</td>
					
				</tr>
			</thead>
			<tbody style="font-size:12px" class="usermeterlist"></tbody>
		</table>
